// ============================================
// SystemesGED v7.2 — MODULE : api.js
// Responsabilités :
//   - Utilisateurs (renderUsers, validateUser, deleteUser, addUser, changeUserStatus)
//   - Utilisateurs en attente (renderPendingUsers, approveAllPending, rejectAllPending)
//   - Tags (renderTags, createTag, deleteTag, editTag)
//   - Paramètres (renderSettings, saveProfile, toggleSetting)
//   - Sécurité (renderSecurity, renderAuditLog, scanAllDocuments, exportAuditLog, exportAllData)
//   - Clés API (renderApiKeys, generateApiKeyV6, revokeApiKey, copyApiKey)
//   - Intégrations & Webhooks (renderIntegrations, connectIntegration, addWebhook)
//   - Audit V6 (renderAuditV6, filterAuditLogs, setAuditFilter)
//   - Analytics (renderAnalytics, exportAnalytics, refreshAnalytics)
//   - Dossiers (renderFolders, renderFolderContents, createFolder, deleteFolder, moveDocument)
//   - Signatures électroniques (renderSignatures, openSignModal, submitSignature)
//   - IA (renderAI, analyzeDocument, askAI)
//   - Automation (renderAutomation, createWfRule, quickCreateRule)
//   - Sauvegardes (renderBackups, createBackup, restoreBackup)
//   - Facturation (renderBilling, selectPlan, simulateUpgrade)
//   - Logs système (renderSysLogs, filterLogs, clearSysLogs, exportSysLogs)
//   - RBAC (renderRBAC, renderRBACV7, openRoleModal, saveRole, updateUserRole)
//   - Versioning (renderVersioning, showVersionHistory, createNewVersion, restoreVersion)
//   - Recherche avancée (renderAdvancedSearch, runAdvSearch, runFTSearch, renderSearchV7)
// ============================================
